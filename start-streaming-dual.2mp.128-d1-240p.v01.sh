...
in=$(( $1 + 100 ))
  ...
  st=0
    ...
    do
      ...
      /snap/bin/vlc -I dummy -vvv -L --syslog /home/mishin/ltv-box/video/h264/d1/one.wild.day.240p.d1.mkv --start-time $st --sout "#rtp{sdp=rtsp://192.168.1.$i:554/test1}" --sout-rtsp-user admin --sout-rtsp-pwd 12345678 2>/dev/null &
